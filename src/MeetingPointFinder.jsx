      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 p-4 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl shadow-sm">
          <p className="text-sm text-gray-700 text-center">
            <strong>Beta-Version:</strong> Diese Website befindet sich aktuell in einer Beta-Version – alle Angaben ohne Gewähr. 
            Feedback gerne jederzeit an{' '}
            <a href="mailto:halfways-meetingfinder@outlook.com" className="text-indigo-600 hover:underline font-medium">
              halfways-meetingfinder@outlook.com
            </a>
          </p>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <p className="text-gray-600 mb-8 text-lg">
            Finde den optimalen Treffpunkt mit minimaler Reisezeit für alle Teilnehmer:innen.
          </p>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 text-center">
            <a 
              href="/impressum" 
              className="text-sm text-gray-600 hover:text-indigo-600 transition-colors underline"
            >
              Impressum
            </a>
          </div>
